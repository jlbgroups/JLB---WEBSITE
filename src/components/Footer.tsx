        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-5">
              <img src="/shnoor-logo.jfif" alt="Shnoor Logo" className="h-9 w-auto object-contain" style={{ filter: 'grayscale(1) invert(1) brightness(1.5)', mixBlendMode: 'screen' }} />
            ...
            <div className="flex gap-2.5">
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/shnoor-international/" target="_blank" rel="noreferrer"
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/shnoor_international_llc?igsh=MW5tenVxODg4bnk4NA==" target="_blank" rel="noreferrer"
                className="w-9 h-9 rounded-lg bg-white/8 hover:bg-accent transition-all duration-200 flex items-center justify-center"
      ...
      <div className="border-t border-white/8">
        <div className="max-w-container mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-5">
            <Link to="/privacy" className="text-white/30 hover:text-white/60 text-[12px] transition-colors">Privacy Policy</Link>
            <Link to="/terms" className="text-white/30 hover:text-white/60 text-[12px] transition-colors">Terms & Conditions</Link>
            <a href="/shnoor-international-company-profile.pdf" download="shnoor-international-company-profile.pdf" className="text-white/30 hover:text-white/60 text-[12px] transition-colors">Company Profile</a>
          </div>
        </div>
      </div>
    </footer>
